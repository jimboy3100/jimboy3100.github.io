...
//Put your webhook for generalChannel and serverChannel (2nd webhook) for the script to work
        ...
        var generalChannel="https://discordapp.com/api/webhooks/655203017385312284/QFVOl7S6baZ7Jw_XKGA8cxKmO_EpCHNiXimV5c2oPUAsjVAbcL5ZCxP4CaQ8jI98ZDpO";
...
function popAgarURL( fun ) {
    ...
    WebSocket.prototype.send = function(b) {
		...
		else if ($( "#AgarToolSettingsButton" ).length){ //IF using Agar Tools
...
function postToDiscord(discordUrl,isGeneralChannel) {
    popAgarURL( function( serverlinks ) {
        ...
        //if (previousUrl!=discordUrl) {
			...
			if ($( "#AgarToolSettingsButton" ).length){
...
console.group('%cAgar Notifies Webhooks №2%c  %chttp://www.jimboy3100.github.io',stylesLegendModConsole1, 'font-size: 48px; background: url(https://jimboy3100.github.io/banners/icon48.png) no-repeat' , stylesLegendModConsole1);
