...
$("#menuBg").val("http://cdn.wallpapersafari.com/36/61/WGbrP0.jpeg");
$("#menuBg").blur();
...
$("#minimapPicture").val("https://jimboy3100.github.io/dyinglightbabyteamboard.png");
$("#minimapPicture").blur();
$("#minbtext").val("The Map");
$("#minbtext").blur();
//$("#leadbPicture").val("https://jimboy3100.github.io/dyinglightbabyleaderboard.png");
//$("#leadbPicture").blur();
...
$("#skin").click();
$("#skin").val("http://i.imgur.com/5zLjitu.gif");
$("#skin").blur();
...
$("#canvasPicture").val("http://dyinglightgame.com/gallery/screenshots/13.jpg");
$("#canvasPicture").blur();
aab();
}
...
function aab2(){
setTimeout(function () {
$("#canvasPicture").val("http://im.ziffdavisinternational.com/ign_fi/screenshot/default/dyinglight-screenshot01-gamescom_n6kb.jpg");
$("#canvasPicture").blur();
aab3();
}, 20000);
}
function aab3(){
setTimeout(function () {
$("#canvasPicture").val("https://staticdelivery.nexusmods.com/mods/793/images/87-1-1424345802.jpg");
$("#canvasPicture").blur();
aab4();
}, 20000);
}
function aab4(){
setTimeout(function () {
$("#canvasPicture").val("http://www.pcgameshardware.de/screenshots/original/2015/01/wallpaper_dying_light_03_2560x1440-pc-games.jpg");
$("#canvasPicture").blur();
aab5();
}, 20000);
}
function aab5(){
setTimeout(function () {
$("#canvasPicture").val("https://images2.alphacoders.com/547/thumb-1920-547831.jpg");
$("#canvasPicture").blur();
aab6();
}, 20000);
}
function aab6(){
setTimeout(function () {
$("#canvasPicture").val("https://images5.alphacoders.com/567/thumb-1920-567536.jpg");
$("#canvasPicture").blur();
aab();
}, 20000);
}
...
$("#minimapPicture").val("https://i.imgur.com/5jIjJVc.gif");
$("#minimapPicture").blur();
setTimeout(function () {
$("#minimapPicture").val("https://jimboy3100.github.io/dyinglightbabyteamboard.png");
$("#minimapPicture").blur();
