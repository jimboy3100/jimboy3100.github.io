...
setTimeout(function () {$("#playerBtn").focusout();
if($("#nick").val()==""){$("#nick").val("The Dying Light"); }
}, 2100);
...
$("#minimap").css('background-image', 'url(https://i.imgur.com/5jIjJVc.gif)');		
setTimeout(function () {
$("#minimap").css('background-image', 'url(https://jimboy3100.github.io/banners/dyinglightbabyteamboard.png)');		
