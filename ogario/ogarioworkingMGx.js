	...
	! function (more2ogarset, more1ogarset, moreogarset) {
		...
		var _0x1e0996 = {
			...
			'onPlayerSpawn': function () {
				if (more1ogarset[`play`] = !0x0, more1ogarset[`playerColor`]) return this['sendPlayerSpawn'](), void this['cacheCustomSkin'](_0x37dab4[`nick`], more1ogarset['playerColor'], _0x37dab4[`skinURL`]);
				var ogarsettings = this;
				setTimeout(function () {
			...
			'sendChatMessage': function (ogarsettings, more2ogarset) {
				if (!(Date[`now`]() - this[`lastMessageSentTime`] < 0x1f4 || 0x0 == more2ogarset[`length`] || 0x0 == _0x37dab4[`nick`][`length`]) && this['isSocketOpen']()) {
					more2ogarset = _0x37dab4['nick'] + ': ' + more2ogarset;
		...
		var doagarcommand = {
			...
			'connect': function (ogarsettings) {
				...
				}, _0x1e0996[`getWS`](this['ws']), _0x1e0996['sendServerJoin'](), _0x1e0996[`sendServerData`](), _0x1e0996[`displayLeaderboard`](''), more2ogarset[`master`] && more2ogarset[`master`][`onConnect`] && more2ogarset[`master`][`onConnect`]();
			},
			...
			'handleMessage': function (ogarsettings) {
				...
				switch (0x36 == more3ogarset && (more3ogarset = 0x35), more3ogarset) {
					...
					case 0x12:
						...
						break;
					case 0x20:
						this[`playerCellIDs`][`push`](ogarsettings[`getUint32`](moreogarset, !0x0)), this[`play`] || (this[`play`] = !0x0, _0x1e0996[`hideMenu`](), this[`playerColor`] = null, _0x1e0996[`onPlayerSpawn`]());
						break;
					case 0x32:
						this[`pieChart`] = [];
			...
			'updateCells': function (ogarsettings, more1ogarset) {
				...
				for (more4ogarset = 0x0;;) {
					...
					more1ogarset += 0x2;
					var _0x1c2110 = ogarsettings[`readUInt8`](more1ogarset++),
						_0x21cdbf = 0x0;
			...
			'setCellOppColor': function (ogarsettings, more2ogarset, more1ogarset) {
				return ogarsettings ? _0x37dab4[`color`] : more2ogarset > 0xb ? `#FF008C` : more2ogarset >= 2.5 ? `#BE00FF` : more2ogarset >= 1.25 ? `#FF0A00` : more2ogarset < 1.25 && more2ogarset > 0.75 ? `#FFDC00` : more2ogarset > more1ogarset ? '#00C8FF' : '#64FF00';
			},
