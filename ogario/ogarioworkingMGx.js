	...
	! function (more2ogarset, more1ogarset, moreogarset) {
		...
		var more5ogarset = ogarbuffed[ogarlanguage],
			...
			csssettings = {
				...
				'changeThemePreset': function (ogarsettings) {
					this[`changePreset`](ogarsettings, ogarsetTypes), this[`setTheme`]();
				},
				'setFonts': function () {
				...
				'changeMenuPreset': function (ogarsettings) {
					this[`changePreset`](ogarsettings, ogarset1Types), this['setMenu']();
				},
		...
		var ogarminimapdrawer = {
			...
			'toggleSkins': function () {
				more1ogarset[`vanillaSkins`] && more1ogarset['customSkins'] ? more1ogarset[`vanillaSkins`] = !0x1 : !more1ogarset[`vannillaSkins`] && more1ogarset['customSkins'] ? (more1ogarset[`vanillaSkins`] = !0x0, more1ogarset['customSkins'] = !0x1) : (more1ogarset['vanillaSkins'] = !0x0, more1ogarset[`customSkins`] = !0x0);
			},
			...
			'resetZoom': function (ogarsettings) {
				ogarsettings ? (more1ogarset[`zoomResetValue`] = 0x1, more1ogarset[`zoomValue`] = 0x1) : more1ogarset['zoomResetValue'] = 0x0;
			},
			...
			'tryResp': function () {
				if (more1ogarset['play'] || 0x14 == this['retryResp']) this['retryResp'] = 0x0;
				else {
					this['retryResp']++;
					var ogarsettings = this;
					setTimeout(function () {
			...
			'displayParties': function () {
				for (var ogarsettings = '', more2ogarset = 0x0; more2ogarset < this[`parties`]['length']; more2ogarset++) ogarsettings += `<li><a href=\"https://agar.io/#` + this[`parties`][more2ogarset] + `\" onclick=\"$(\'#party-token\').val(\'` + this[`parties`][more2ogarset] + '\'); $(\'#join-party-btn-2\').click();\">https://agar.io/#' + this[`parties`][more2ogarset] + `</a></li>`;
			...
			'displayChatHistory': function (ogarsettings) {
				if (ogarsettings) {
					...
					for (var more2ogarset = 0x0; more2ogarset < this[`chatHistory`][`length`]; more2ogarset++) moreogarset(`#messages`)['append'](`<li><span class=\"message-nick\">` + this[`chatHistory`][more2ogarset][`nick`] + `: </span><span class=\"message-text\">` + this['chatHistory'][more2ogarset][`message`] + `</span></li>`);
			...
			'loadProfiles': function () {
				...
				null !== more2ogarset[`localStorage`][`getItem`](`ogarioSelectedProfile`) && (this[`selectedProfile`] = JSON['parse'](more2ogarset[`localStorage`][`getItem`]('ogarioSelectedProfile'))), ogardefaultprofile[`nick`] = ogario1PlayerProfiles[this[`selectedProfile`]][`nick`], ogardefaultprofile[`clanTag`] = ogario1PlayerProfiles[this['selectedProfile']][`clanTag`], ogardefaultprofile[`skinURL`] = ogario1PlayerProfiles[this['selectedProfile']]['skinURL'], ogardefaultprofile[`color`] = ogario1PlayerProfiles[this[`selectedProfile`]][`color`];
			},
			...
			'setUI': function () {
				...
				moreogarset(document)['on'](`click`, '.menu-tabs a', function (more2ogarset) {
					...
					ogarsettings[`getQuality`](this[`value`]), _0x3eddc8();
			...
			'getDefaultSettings': function () {
				...
				}), moreogarset(`#nick`)[`val`](ogardefaultprofile[`nick`])[`blur`](), moreogarset(`#noNames`)[`prop`](`checked`, !ogario1Settings[`noNames`]), moreogarset(`#showMass`)['prop'](`checked`, ogario1Settings[`showMass`]), this[`unlockButtons`](), this['setAutoResp'](), this[`setQuest`]();
			},
			...
			'setMainButtons': function () {
				...
				moreogarset(document)['on'](`click`, '.btn-play, .btn-play-guest', function () {
					...
					ogarsettings[`skipServerData`] = !0x0, ogarsettings[`joinParty`](), ogarsettings['onJoin']();
			...
			'onPlayerSpawn': function () {
				if (more1ogarset[`play`] = !0x0, more1ogarset[`playerColor`]) return this['sendPlayerSpawn'](), void this['cacheCustomSkin'](ogardefaultprofile[`nick`], more1ogarset['playerColor'], ogardefaultprofile[`skinURL`]);
				var ogarsettings = this;
				setTimeout(function () {
			...
			'onPlayerDeath': function () {
				more1ogarset[`play`] = !0x1, more1ogarset['playerColor'] = null, more1ogarset[`foodIsHidden`] = !0x1, more1ogarset['playerMass'] = 0x0, more1ogarset[`playerScore`] = 0x0, more1ogarset[`playerSplitCells`] = 0x0, this[`showMenu`](0x12c), this[`sendPlayerDeath`](), this[`updateDeathLocations`](more1ogarset[`playerX`], more1ogarset['playerY']), this[`unlockButtons`](), _0x2e41ee(), this[`autoResp`]();
			},
			'setPlayerSettings': function () {
				...
				ogardefaultprofile[`nick`] = ogarsettings, ogardefaultprofile[`clanTag`] = more2ogarset[`trim`](), ogardefaultprofile[`skinURL`] = this[`checkSkinURL`](more3ogarset['trim']()), 0x7 == more4ogarset[`length`] && (ogardefaultprofile[`color`] = more4ogarset), ogardefaultprofile[`clanTag`][`length`] > 0x0 && (more1ogarset[`clanTag`] = ogardefaultprofile[`clanTag`]), ogario1PlayerProfiles[this[`selectedProfile`]][`nick`] = ogardefaultprofile[`nick`], ogario1PlayerProfiles[this[`selectedProfile`]][`clanTag`] = ogardefaultprofile[`clanTag`], ogario1PlayerProfiles[this[`selectedProfile`]][`skinURL`] = ogardefaultprofile[`skinURL`], ogario1PlayerProfiles[this[`selectedProfile`]][`color`] = ogardefaultprofile[`color`], this[`saveSettings`](ogario1PlayerProfiles, `ogarioPlayerProfiles`);
			},
			'loadSkin': function (ogarsettings, more2ogarset) {
				...
				ogarsettings[more2ogarset] = new Image(), ogarsettings[more2ogarset][`crossOrigin`] = `Anonymous`, ogarsettings[more2ogarset]['onload'] = function () {
					this[`complete`] && this[`width`] && this[`height`] && this[`width`] <= 0x7d0 && this['height'] <= 0x7d0 && (more1ogarset['cacheQueue'][`push`](more2ogarset), 0x1 == more1ogarset[`cacheQueue`][`length`] && more1ogarset[`cacheSkin`](more1ogarset['customSkinsCache']));
			...
			'drawMiniMap': function () {
				if (more1ogarset[`mapOffsetFixed`]) {
					...
					if (this['drawSelectedCell'](this[`miniMapCtx`]), this[`currentSector`] = this[`calculateMapSector`](more1ogarset[`playerX`], more1ogarset[`playerY`], !0x0), this[`miniMapCtx`]['globalAlpha'] = 0x1, this['miniMapCtx'][`font`] = ogario1ThemeSettings[`miniMapFontWeight`] + ' ' + (more2ogarset - 0x4) + `px ` + ogario1ThemeSettings['miniMapFontFamily'], this[`miniMapCtx`][`fillStyle`] = ogario1ThemeSettings[`miniMapSectorColor`], this[`miniMapCtx`][`fillText`](this['currentSector'], 0xa, more2ogarset), this['miniMapSectors'] || this[`drawMiniMapSectors`](ogario1ThemeSettings[`sectorsX`], ogario1ThemeSettings[`sectorsY`], more3ogarset, moreogarset, more4ogarset), this['miniMapCtx'][`save`](), this['miniMapCtx']['translate'](9.5, more4ogarset), ':battleroyale' === this[`gameMode`] && ogarfooddrawer && ogarfooddrawer[`drawBattleAreaOnMinimap`](this['miniMapCtx'], more3ogarset, more3ogarset, ogarbuffed, ogarlanguage, ogaractuallanguage), ogario1Settings[`showMiniMapGhostCells`]) {
						...
						for (var ogario1Commands = 0x0; ogario1Commands < more5ogarset[`length`]; ogario1Commands++)
							if (!more5ogarset[ogario1Commands][`inView`]) {
								var ogarparsedchars = ~~((more5ogarset[ogario1Commands]['x'] + ogarlanguage) * ogarbuffed),
									ogarparsedemoticons = ~~((more5ogarset[ogario1Commands]['y'] + ogaractuallanguage) * ogarbuffed);
								this[`miniMapCtx`]['moveTo'](ogarparsedchars, ogarparsedemoticons), this[`miniMapCtx`][`arc`](ogarparsedchars, ogarparsedemoticons, ~~(more5ogarset[ogario1Commands][`size`] * ogarbuffed), 0x0, this[`pi2`], !0x1);
					...
					if (ogario1Settings[`showMiniMapGuides`]) {
						...
						this['miniMapCtx']['lineWidth'] = 0x1, this[`miniMapCtx`][`strokeStyle`] = ogario1ThemeSettings[`miniMapGuidesColor`], this[`miniMapCtx`][`beginPath`](), this[`miniMapCtx`][`moveTo`](ogarparsedchars, 0x0), this['miniMapCtx'][`lineTo`](ogarparsedchars, more3ogarset - 0x1), this[`miniMapCtx`][`moveTo`](0x0, ogarparsedemoticons), this[`miniMapCtx`][`lineTo`](more3ogarset - 0x1, ogarparsedemoticons), this[`miniMapCtx`][`stroke`]();
					}
					...
					if (this[`deathLocations`][`length`] > 0x0) {
						...
						var ogarsetTypes = Math[`max`](ogario1ThemeSettings[`miniMapMyCellSize`] - 0x2, 0x4);
						this[`miniMapCtx`][`lineWidth`] = 0x1, this[`miniMapCtx`][`strokeStyle`] = this[`deathLocations`][`length`] - 0x1 == this[`lastDeath`] ? ogario1ThemeSettings['miniMapDeathLocationColor'] : `#FFFFFF`, this[`miniMapCtx`][`beginPath`](), this['miniMapCtx'][`moveTo`](ogarparsedchars - ogarsetTypes, ogarparsedemoticons), this['miniMapCtx'][`lineTo`](ogarparsedchars + ogarsetTypes, ogarparsedemoticons), this[`miniMapCtx`][`moveTo`](ogarparsedchars, ogarparsedemoticons - ogarsetTypes), this['miniMapCtx'][`lineTo`](ogarparsedchars, ogarparsedemoticons + ogarsetTypes), this['miniMapCtx'][`stroke`]();
					}
			...
			'drawMiniMapSectors': function (ogarsettings, more2ogarset, moreogarset, more3ogarset, more4ogarset) {
				...
				ogarbuffed[`ogarioCtx`] = !0x0, this[`miniMapSectors`]['width'] = moreogarset, this['miniMapSectors'][`height`] = more3ogarset, ogarbuffed[`fillStyle`] = '#FFFFFF', this[`dTok`](ogarbuffed, moreogarset - 0x1), ogarfooddrawer[`drawSectors`](ogarbuffed, more1ogarset[`mapOffsetFixed`], ogarsettings, more2ogarset, 0.5, more4ogarset, moreogarset - 0.5, more3ogarset - 9.5, ogario1ThemeSettings['miniMapSectorsColor'], ogario1ThemeSettings[`miniMapSectorsColor`], 0x1, !0x1);
			},
			...
			'drawCellInfo': function (ogarsettings, more2ogarset, moreogarset, more3ogarset, more4ogarset, ogarbuffed, ogarlanguage, ogaractuallanguage, more5ogarset, ogario1Commands, ogarparsedchars, ogarparsedemoticons) {
				if (!ogarbuffed && !more5ogarset && (ogarsettings[`globalAlpha`] = more1ogarset[`globalAlpha`], ogario1Settings[`teammatesInd`] && ogarparsedemoticons && !ogaractuallanguage && more4ogarset <= 0xc8 && this[`drawTeammatesInd`](ogarsettings, moreogarset, more3ogarset, more4ogarset), !ogario1Settings[`noNames`] || ogario1Settings[`showMass`])) {
					var ogarsetTypes = !0x1;
					if (ogaractuallanguage || ogarlanguage || !(ogarsetTypes = this[`setAutoHideCellInfo`](more4ogarset)) || !ogario1Settings[`autoHideNames`] || !ogario1Settings[`autoHideMass`]) {
						var ogarset1Types = null;
						if (!this[`cells`][`hasOwnProperty`](more2ogarset)) return (ogarset1Types = new _0x24291c(moreogarset, more3ogarset, ogarlanguage, ogaractuallanguage, ogario1Settings['shortMass'], ogario1Settings[`virMassShots`]))[`setMass`](more4ogarset), ogarset1Types['setNick'](ogario1Commands), void(this[`cells`][more2ogarset] = ogarset1Types);
						(ogarset1Types = this[`cells`][more2ogarset])[`update`](moreogarset, more3ogarset, more4ogarset, ogarlanguage, ogaractuallanguage, ogario1Commands), ogarset1Types[`setDrawing`](ogario1Settings[`optimizedNames`], ogario1Settings[`optimizedMass`], ogario1Settings[`shortMass`], ogario1Settings['virMassShots'], ogario1Settings[`namesStroke`], ogario1Settings['massStroke']), ogarset1Types[`setDrawingScale`](more1ogarset['viewScale'], ogario1ThemeSettings[`namesScale`], ogario1ThemeSettings[`massScale`], ogario1ThemeSettings['virMassScale'], ogario1ThemeSettings[`strokeScale`]), ogarsettings[`globalAlpha`] = ogario1ThemeSettings[`textAlpha`], ogario1Settings[`noNames`] || ogarsetTypes && ogario1Settings[`autoHideNames`] || ogaractuallanguage && ogario1Settings['hideMyName'] || ogarparsedemoticons && ogario1Settings[`hideTeammatesNames`] || ogarset1Types[`drawNick`](ogarsettings, ogario1ThemeSettings[`namesColor`], ogario1ThemeSettings[`namesFontFamily`], ogario1ThemeSettings[`namesFontWeight`], ogario1ThemeSettings['namesStrokeColor']), !ogario1Settings[`showMass`] || ogarsetTypes && ogario1Settings[`autoHideMass`] || ogaractuallanguage && ogario1Settings['hideMyMass'] || ogario1Settings[`hideEnemiesMass`] && !ogaractuallanguage && !ogarlanguage || ogarset1Types['drawMass'](ogarsettings, ogario1ThemeSettings['massColor'], ogario1ThemeSettings[`massFontFamily`], ogario1ThemeSettings[`massFontWeight`], ogario1ThemeSettings['massStrokeColor']);
					}
				}
			},
			...
			'setParty': function () {
				...
				if (this[`gameMode`] = more1ogarset[`gameMode`] = moreogarset(`#gamemode`)[`val`](), this[`setQuest`](), `:party` === this['gameMode'] && ogarsettings) {
					var more2ogarset = ogarsettings; - 0x1 != ogarsettings[`indexOf`]('#') && (more2ogarset = (ogarsettings = ogarsettings[`split`]('#'))[0x1]), this[`partyToken`] !== more2ogarset && (this['partyToken'] = more2ogarset, this[`flushSkinsMap`](), this[`flushChatData`](), this[`cancelTargeting`]());
				}
			},
			...
			'flushData': function () {
				this[`flushPartyData`](), this[`flushSkinsMap`](), this[`flushChatData`](), this[`cancelTargeting`](), more1ogarset[`play`] = !0x1, more1ogarset['playerColor'] = null;
			},
			...
			'getWS': function (ogarsettings) {
				ogarsettings && (this['ws'] = ogarsettings, this[`createServerToken`](), this[`updateServerInfo`](), -0x1 == this['ws'][`indexOf`](`agar.io`) && this[`closeConnection`]());
			},
			...
			'gameServerConnect': function (ogarsettings) {
				ogarsettings && (this[`skipServerData`] = !0x0, more2ogarset[`core`] && more2ogarset['core']['connect'] && more2ogarset[`core`]['connect'](ogarsettings));
			},
			...
			'gameServerJoin': function (ogarsettings) {
				...
				more2ogarset && (this[`skipServerData`] = !0x0, this[`gameServerConnect`](more2ogarset));
			},
			'connect': function () {
				this[`closeConnection`](), this[`flushData`](), this[`setParty`](), console[`log`](`[Legend mod Express] Connecting to server`), this['privateMode'] && this[`privateIP`] ? this[`socket`] = new WebSocket(this[`privateIP`]) : this[`socket`] = new WebSocket(this[`publicIP`]), this[`socket`][`ogarioWS`] = !0x0, this[`socket`][`binaryType`] = `arraybuffer`;
				var ogarsettings = this;
				this[`socket`][`onopen`] = function () {
					console['log']('[Legend mod Express] Socket open');
					var more2ogarset = ogarsettings['createView'](0x3);
					more2ogarset[`setUint8`](0x0, 0x0), more2ogarset[`setUint16`](0x1, 0x191, !0x0), ogarsettings['sendBuffer'](more2ogarset), ogarsettings[`sendPartyData`]();
			...
			'strToBuff': function (ogarsettings, more2ogarset) {
				var more1ogarset = this[`createView`](0x1 + 0x2 * more2ogarset['length']);
				more1ogarset['setUint8'](0x0, ogarsettings);
				for (var moreogarset = 0x0; moreogarset < more2ogarset[`length`]; moreogarset++) more1ogarset[`setUint16`](0x1 + 0x2 * moreogarset, more2ogarset[`charCodeAt`](moreogarset), !0x0);
				return more1ogarset;
			},
			...
			'readMessage': function (ogarsettings) {
				switch (ogarsettings[`getUint8`](0x0)) {
					case 0x0:
						this[`playerID`] = ogarsettings['getUint32'](0x1, !0x0);
						break;
					case 0x1:
			...
			'sendPlayerState': function (ogarsettings) {
				if (this[`isSocketOpen`]()) {
					var more2ogarset = this['createView'](0x1);
					more2ogarset[`setUint8`](0x0, ogarsettings), this[`sendBuffer`](more2ogarset);
				}
			},
			...
			'sendPlayerNick': function () {
				this[`sendPlayerData`](0xa, 'lastSentNick', ogardefaultprofile[`nick`]);
			},
			'sendPlayerClanTag': function () {
				this[`sendPlayerData`](0xb, `lastSentClanTag`, ogardefaultprofile[`clanTag`]);
			},
			'sendPlayerSkinURL': function () {
				this['sendPlayerData'](0xc, `lastSentSkinURL`, ogardefaultprofile['skinURL']);
			},
			'sendPlayerCustomColor': function () {
				this[`sendPlayerData`](0xd, `lastSentCustomColor`, ogardefaultprofile[`color`]);
			},
			...
			'sendServerRegion': function () {
				if (this[`region`]) {
					...
					this[`isSocketOpen`]() && this[`sendBuffer`](this[`strToBuff`](0x11, ogarsettings[0x0]));
				}
			},
			...
			'sendServerData': function () {
				this[`skipServerData`] ? this[`skipServerData`] = !0x1 : (this['region'] = moreogarset('#region')[`val`](), this[`gameMode`] = moreogarset('#gamemode')[`val`](), this['sendServerRegion'](), this[`sendServerGameMode`]());
			},
			...
			'sendPlayerUpdate': function () {
				if (this[`isSocketOpen`]() && more1ogarset[`play`] && this['playerID'] && more1ogarset[`playerColor`]) {
					...
					more2ogarset += 0x2 * ogardefaultprofile[`nick`][`length`], more2ogarset += 0x2 * ogardefaultprofile[`skinURL`][`length`];
					...
					ogarsettings(ogardefaultprofile[`nick`]), ogarsettings(ogardefaultprofile['skinURL']), ogarsettings(ogardefaultprofile[`color`]), ogarsettings(more1ogarset['playerColor']), this['sendBuffer'](moreogarset);
				}
			},
			'sendPlayerPosition': function () {
				if (this['isSocketOpen']() && more1ogarset[`play`] && this[`playerID`]) {
					var ogarsettings = this['createView'](0x11);
					ogarsettings[`setUint8`](0x0, 0x1e), ogarsettings[`setUint32`](0x1, this[`playerID`], !0x0), ogarsettings['setInt32'](0x5, this[`getPlayerX`](), !0x0), ogarsettings[`setInt32`](0x9, this['getPlayerY'](), !0x0), void 0x0 !== more1ogarset[`playerMass`] ? ogarsettings[`setUint32`](0xd, more1ogarset[`playerMass`], !0x0) : ogarsettings['setUint32'](0xd, this[`playerMass`], !0x0), this[`sendBuffer`](ogarsettings);
				}
			},
			'checkPlayerID': function (ogarsettings) {
				if (ogarsettings)
					for (var more2ogarset = 0x0; more2ogarset < this[`teamPlayers`][`length`]; more2ogarset++)
			...
			'updateTeamPlayer': function (ogarsettings) {
				function more2ogarset() {
					for (var more2ogarset = '';;) {
						var more1ogarset = ogarsettings[`getUint16`](moreogarset, !0x0);
						if (0x0 == more1ogarset) break;
			...
			'updateTeamPlayers': function () {
				...
				for (var ogarsettings = 0x0; ogarsettings < this[`teamPlayers`][`length`]; ogarsettings++) {
					var more2ogarset = this[`teamPlayers`][ogarsettings];
					(more2ogarset[`alive`] && Date[`now`]() - more2ogarset[`updateTime`] >= 0x7d0 || 0x0 == more2ogarset['mass']) && (more2ogarset[`alive`] = !0x1, this[`targeting`] && this[`targetID`] && more2ogarset['id'] == this[`targetID`] && this[`setTargetStatus`](0x2)), more2ogarset[`alive`] && (this[`top5`][`push`]({
						'id': more2ogarset['id'],
			...
			'sendChatMessage': function (ogarsettings, more2ogarset) {
				if (!(Date[`now`]() - this[`lastMessageSentTime`] < 0x1f4 || 0x0 == more2ogarset[`length`] || 0x0 == ogardefaultprofile[`nick`][`length`]) && this['isSocketOpen']()) {
					more2ogarset = ogardefaultprofile['nick'] + ': ' + more2ogarset;
					var more1ogarset = this[`createView`](0xa + 0x2 * more2ogarset['length']);
					more1ogarset['setUint8'](0x0, 0x64), more1ogarset[`setUint8`](0x1, ogarsettings), more1ogarset[`setUint32`](0x2, this[`playerID`], !0x0), more1ogarset[`setUint32`](0x6, 0x0, !0x0);
					for (var moreogarset = 0x0; moreogarset < more2ogarset[`length`]; moreogarset++) more1ogarset[`setUint16`](0xa + 0x2 * moreogarset, more2ogarset['charCodeAt'](moreogarset), !0x0);
			...
			'isChatUserMuted': function (ogarsettings) {
				return -0x1 != this[`chatMutedUserIDs`]['indexOf'](ogarsettings);
			},
			...
			'playSound': function (ogarsettings) {
				ogarsettings && ogarsettings[`play`] && (ogarsettings[`pause`](), ogarsettings['currentTime'] = 0x0, ogarsettings[`play`]());
			},
			...
			'changeTarget': function () {
				for (var ogarsettings = this[`checkPlayerID`](this['targetID']), more2ogarset = null, more1ogarset = 0x0; more1ogarset < this[`teamPlayers`][`length`]; more1ogarset++)
			...
			this['id'] = ogarsettings, this['x'] = more2ogarset, this['y'] = moreogarset, this[`targetX`] = more2ogarset, this[`targetY`] = moreogarset, this[`color`] = more4ogarset, this[`oppColor`] = null, this['size'] = more3ogarset, this[`targetSize`] = more3ogarset, this[`alpha`] = 0x1, this['nick'] = '', this['targetNick'] = '', this[`nickCanvas`] = null, this[`mass`] = 0x0, this[`lastMass`] = 0x0, this[`kMass`] = 0x0, this['massCanvas'] = null, this['massTxt'] = '', this[`margin`] = 0x0, this['scale'] = 0x1, this['nickScale'] = 0x1, this[`massScale`] = 0x1, this[`virMassScale`] = 0x3, this[`strokeScale`] = 0x1, this[`fontSize`] = 0x1a, this['nickSize'] = 0x1a, this[`lastNickSize`] = 0x0, this[`massSize`] = 0x1a, this[`virMassSize`] = 0x1a, this[`nickStrokeSize`] = 0x3, this[`massStrokeSize`] = 0x3, this[`isFood`] = ogarbuffed, this[`isVirus`] = ogarlanguage, this['isPlayerCell'] = ogaractuallanguage, this[`shortMass`] = more5ogarset, this[`virMassShots`] = ogario1Commands, this[`rescale`] = !0x1, this[`redrawNick`] = !0x0, this[`redrawMass`] = !0x0, this[`optimizedNames`] = !0x1, this[`optimizedMass`] = !0x1, this[`strokeNick`] = !0x1, this[`strokeMass`] = !0x1, this[`removed`] = !0x1, this[`redrawed`] = 0x0, this[`time`] = 0x0, this[`skin`] = null, this[`pi2`] = 0x2 * Math['PI'],
				...
				this['update'] = function (ogarsettings, more2ogarset, more1ogarset, moreogarset, more3ogarset, more4ogarset) {
					...
					if (this[`massCanvas`] && !(this[`size`] <= 0x28)) {
						...
						let massImg = massCanvas.drawTxt(),
							...
							ogarcanvasdrawerMass = this.margin === 0 ? ~~(this.y - h / 2) : ~~this.y + this.margin;
						if (w > 1 && h > 1) {
							mainCanvas.drawImage(massImg, ~~(this.x - w / 2), ogarcanvasdrawerMass, w, h);
						}
					}
				},
				...
				this[`draw`] = function (ogarsettings, more2ogarset) {
					if (!(doagarcommand[`hideSmallBots`] && this['size'] <= 0x24)) {
						...
						if (this[`isVirus`]) {
							return ogario1Settings[`transparentViruses`] && (ogarsettings[`globalAlpha`] *= ogario1ThemeSettings[`virusAlpha`], moreogarset = !0x0), ogario1Settings['virColors'] && doagarcommand[`play`] ? (ogarsettings['fillStyle'] = ogarminimapdrawer[`setVirusColor`](more3ogarset), ogarsettings['strokeStyle'] = ogarminimapdrawer[`setVirusStrokeColor`](more3ogarset)) : (ogarsettings['fillStyle'] = this.virusColor, ogarsettings[`strokeStyle`] = this.virusStroke), ogarsettings[`fill`](), moreogarset && (ogarsettings['globalAlpha'] = more1ogarset, moreogarset = !0x1), ogarsettings['lineWidth'] = ogario1ThemeSettings[`virusStrokeSize`], ogarsettings[`stroke`](this.createStrokeVirusPath(this.x, this.y, this.size - 2, 6)), ogario1Settings['showMass'] && (this[`setDrawing`](), this[`setDrawingScale`](), this['setMass'](this['size']), this['drawMass'](ogarsettings)), void ogarsettings[`restore`]();
						}
						...
						doagarcommand[`play`] && (this[`isPlayerCell`] ? ogario1Settings[`myCustomColor`] && (more4ogarset = ogardefaultprofile[`color`]) : ogario1Settings[`oppColors`] && !ogario1Settings[`oppRings`] && (more4ogarset = this['oppColor'])), ogarsettings[`fillStyle`] = more4ogarset, ogarsettings[`fill`](), moreogarset && (ogarsettings['globalAlpha'] = more1ogarset, moreogarset = !0x1);
						var ogarbuffed = null;
						if (ogario1Settings['customSkins'] && doagarcommand['showCustomSkins'] && (ogarbuffed = ogarminimapdrawer['getCustomSkin'](this['targetNick'], this['color'])) && (((ogario1Settings[`transparentSkins`] || doagarcommand[`play`] && ogario1Settings[`oppColors`]) && (!this[`isPlayerCell`] || ogario1Settings['myTransparentSkin']) || this['isPlayerCell'] && ogario1Settings['myTransparentSkin']) && (ogarsettings[`globalAlpha`] *= ogario1ThemeSettings[`skinsAlpha`], moreogarset = !0x0), ogarsettings[`drawImage`](ogarbuffed, this['x'] - more3ogarset, this['y'] - more3ogarset, 0x2 * more3ogarset, 0x2 * more3ogarset), moreogarset && (ogarsettings[`globalAlpha`] = more1ogarset, moreogarset = !0x1)), ogario1Settings[`teammatesInd`] && !this[`isPlayerCell`] && more3ogarset <= 0xc8 && (ogarbuffed || ogarminimapdrawer[`checkSkinsMap`](this[`targetNick`], this[`color`])) && ogarfooddrawer[`drawTeammatesInd`](ogarsettings, this['x'], this['y'], more3ogarset), ogario1Settings[`noNames`] && !ogario1Settings[`showMass`] || more2ogarset) ogarsettings['restore']();
						else {
		...
		var doagarcommand = {
			...
			'connect': function (ogarsettings) {
				...
				var more1ogarset = this;
				this[`closeConnection`](), this[`flushCellsData`](), this[`protocolKey`] = null, this[`clientKey`] = null, this[`accessTokenSent`] = !0x1, this[`connectionOpened`] = !0x1, this[`mapOffsetFixed`] = !0x1, this[`leaderboard`] = [], this['ws'] = ogarsettings, this[`socket`] = new WebSocket(ogarsettings), this['socket'][`binaryType`] = `arraybuffer`, this[`socket`][`onopen`] = function () {
					more1ogarset[`onOpen`]();
			...
			'onOpen': function (ogarsettings) {
				...
				more2ogarset[`setUint8`](0x0, 0xfe), more2ogarset['setUint32'](0x1, 0x14, !0x0), this[`sendMessage`](more2ogarset), (more2ogarset = this['createView'](0x5))[`setUint8`](0x0, 0xff), more2ogarset[`setUint32`](0x1, this[`clientVersion`], !0x0), this[`sendMessage`](more2ogarset), this[`connectionOpened`] = !0x0;
			},
			...
			'sendAction': function (ogarsettings) {
				if (this[`isSocketOpen`]()) {
					var more2ogarset = this[`createView`](0x1);
					more2ogarset[`setUint8`](0x0, ogarsettings), this[`sendMessage`](more2ogarset);
				}
			},
			...
			'sendNick': function (ogarsettings) {
				...
				var more1ogarset = this[`createView`](0x1 + ogarsettings[`length`]);
				more1ogarset[`setUint8`](0x0, 0x0);
				for (var moreogarset = 0x0; moreogarset < ogarsettings['length']; moreogarset++) more1ogarset[`setUint8`](moreogarset + 0x1, ogarsettings[`charCodeAt`](moreogarset));
			...
			'sendPosition': function () {
				if (this[`isSocketOpen`]() && this[`connectionOpened`] && this[`clientKey`]) {
					...
					more1ogarset[`setUint8`](0x0, 0x10), more1ogarset[`setInt32`](0x1, ogarsettings, !0x0), more1ogarset['setInt32'](0x5, more2ogarset, !0x0), more1ogarset[`setUint32`](0x9, this['protocolKey'], !0x0), this['sendMessage'](more1ogarset);
				}
			},
			...
			'sendRecaptcha': function (ogarsettings) {
				...
				more2ogarset[`setUint8`](0x0, 0x56);
				for (var more1ogarset = 0x0; more1ogarset < ogarsettings[`length`]; more1ogarset++) more2ogarset[`setUint8`](0x1 + more1ogarset, ogarsettings[`charCodeAt`](more1ogarset));
				more2ogarset[`setUint8`](ogarsettings[`length`] + 0x1, 0x0), this[`sendMessage`](more2ogarset);
			},
			...
			'generateClientKey': function (ogarsettings, more2ogarset) {
				...
				for (var ogaractuallanguage = new DataView(ogarbuffed[`buffer`]), more5ogarset = more4ogarset - 0x1, ogario1Commands = 0x4 + (more5ogarset - 0x4 & -0x4) | 0x0, ogarparsedchars = 0xff ^ more5ogarset, ogarparsedemoticons = 0x0; more5ogarset > 0x3;) more1ogarset = 0x0 | Math['imul'](ogaractuallanguage[`getInt32`](ogarparsedemoticons, !0x0), moreogarset), ogarparsedchars = (0x0 | Math[`imul`](more1ogarset >>> 0x18 ^ more1ogarset, moreogarset)) ^ (0x0 | Math[`imul`](ogarparsedchars, moreogarset)), more5ogarset -= 0x4, ogarparsedemoticons += 0x4;
				switch (more5ogarset) {
					case 0x3:
						ogarparsedchars = ogarbuffed[ogario1Commands + 0x2] << 0x10 ^ ogarparsedchars, ogarparsedchars = ogarbuffed[ogario1Commands + 0x1] << 0x8 ^ ogarparsedchars;
						break;
					case 0x2:
						ogarparsedchars = ogarbuffed[ogario1Commands + 0x1] << 0x8 ^ ogarparsedchars;
						break;
					case 0x1:
						break;
					default:
				...
				return more1ogarset != ogarparsedchars && (more1ogarset = 0x0 | Math[`imul`](ogarbuffed[ogario1Commands] ^ ogarparsedchars, moreogarset)), more1ogarset ^= ogarparsedchars = more1ogarset >>> 0xd, more1ogarset = 0x0 | Math[`imul`](more1ogarset, moreogarset), more1ogarset ^= ogarparsedchars = more1ogarset >>> 0xf, console[`log`]('[Legend mod Express] Generated client key:', more1ogarset), more1ogarset;
			},
			...
			'shiftMessage': function (ogarsettings, more2ogarset, more1ogarset) {
				if (more1ogarset)
					for (moreogarset = 0x0; moreogarset < ogarsettings[`length`]; moreogarset++) ogarsettings['writeUInt8'](ogarsettings['readUInt8'](moreogarset) ^ more2ogarset >>> moreogarset % 0x4 * 0x8 & 0xff, moreogarset);
				else
					for (var moreogarset = 0x0; moreogarset < ogarsettings[`byteLength`]; moreogarset++) ogarsettings[`setUint8`](moreogarset, ogarsettings[`getUint8`](moreogarset) ^ more2ogarset >>> moreogarset % 0x4 * 0x8 & 0xff);
				return ogarsettings;
			},
			...
			'handleMessage': function (ogarsettings) {
				...
				switch (0x36 == more3ogarset && (more3ogarset = 0x35), more3ogarset) {
					case 0x5:
						break;
					case 0x11:
						this[`viewX`] = ogarsettings['getFloat32'](moreogarset, !0x0), moreogarset += 0x4, this['viewY'] = ogarsettings[`getFloat32`](moreogarset, !0x0), moreogarset += 0x4, this[`scale`] = ogarsettings[`getFloat32`](moreogarset, !0x0);
						break;
					case 0x12:
						this[`protocolKey`] && (this[`protocolKey`] = this[`shiftKey`](this[`protocolKey`])), this[`flushCellsData`]();
						break;
					case 0x20:
						this[`playerCellIDs`][`push`](ogarsettings[`getUint32`](moreogarset, !0x0)), this[`play`] || (this[`play`] = !0x0, ogarminimapdrawer[`hideMenu`](), this[`playerColor`] = null, ogarminimapdrawer[`onPlayerSpawn`]());
						break;
					case 0x32:
						this[`pieChart`] = [];
						...
						break;
					case 0x35:
						if (this[`leaderboard`] = [], this[`playerPosition`] = 0x0, 0x36 == ogarsettings[`getUint8`](0x0)) {
					...
					case 0x36:
						break;
					case 0x45:
						var ogarparsedchars = ogarsettings[`getUint16`](moreogarset, !0x0);
						moreogarset += 0x2, this['ghostCells'] = [];
						for (ogarbuffed = 0x0; ogarbuffed < ogarparsedchars; ogarbuffed++) {
							var ogarparsedemoticons = ogarsettings[`getInt32`](moreogarset, !0x0);
							moreogarset += 0x4;
							var ogarsetTypes = ogarsettings[`getInt32`](moreogarset, !0x0);
							moreogarset += 0x4;
							var ogarset1Types = ogarsettings[`getUint32`](moreogarset, !0x0);
							moreogarset += 0x5;
							var ogario1ThemeSettings = ~~Math['sqrt'](0x64 * ogarset1Types);
							this[`ghostCells`][`push`]({
								'x': ogarparsedemoticons,
								'y': ogarsetTypes,
								'size': ogario1ThemeSettings,
								'mass': ogarset1Types,
								'inView': this[`isInView`](ogarparsedemoticons, ogarsetTypes, ogario1ThemeSettings)
							});
						}
						break;
					case 0x55:
					...
					case 0xa1:
						break;
					case 0xb0:
						this[`battleRoyale`][`startTime`] = ogarsettings['getUint32'](moreogarset, !0x0);
						break;
					case 0xb1:
						this[`battleRoyale`][`joined`] = !0x0;
						break;
					case 0xb2:
						this[`battleRoyale`]['players'] = ogarsettings[`getUint16`](moreogarset, !0x0), moreogarset += 0x2;
						var csssettings = ogarsettings[`getUint16`](moreogarset, !0x0);
						moreogarset += 0x2, csssettings || (this[`battleRoyale`]['state'] = 0x0, this['battleRoyale'][`joined`] = !0x1), 0x3 & csssettings && (this[`battleRoyale`][`state`] = ogarsettings[`getUint8`](moreogarset++), this[`battleRoyale`]['x'] = ogarsettings['getInt32'](moreogarset, !0x0), moreogarset += 0x4, this[`battleRoyale`]['y'] = ogarsettings['getInt32'](moreogarset, !0x0), moreogarset += 0x4, this[`battleRoyale`][`radius`] = ogarsettings[`getUint32`](moreogarset, !0x0), moreogarset += 0x4, this[`battleRoyale`][`shrinkTime`] = 0x3e8 * ogarsettings[`getUint32`](moreogarset, !0x0), moreogarset += 0x4, this[`battleRoyale`]['shrinkTime'] && (this[`battleRoyale`][`timeLeft`] = ~~((this[`battleRoyale`]['shrinkTime'] - Date[`now`]() + this[`serverTimeDiff`]) / 0x3e8), this[`battleRoyale`][`timeLeft`] < 0x0 && (this[`battleRoyale`][`timeLeft`] = 0x0))), 0x2 & csssettings && (this[`battleRoyale`][`targetX`] = ogarsettings[`getInt32`](moreogarset, !0x0), moreogarset += 0x4, this['battleRoyale'][`targetY`] = ogarsettings[`getInt32`](moreogarset, !0x0), moreogarset += 0x4, this[`battleRoyale`][`targetRadius`] = ogarsettings['getUint32'](moreogarset, !0x0));
						break;
					case 0xb3:
					...
					case 0xe2:
						break;
					case 0xf1:
						this['protocolKey'] = ogarsettings[`getUint32`](moreogarset, !0x0), console[`log`](`[Legend mod Express] Received protocol key:`, this[`protocolKey`]);
						var ogarcanvasrenderer = new Uint8Array(ogarsettings[`buffer`], moreogarset += 0x4);
						this[`clientKey`] = this[`generateClientKey`](this['ws'], ogarcanvasrenderer), more2ogarset[`master`] && more2ogarset[`master`][`login`] && more2ogarset[`master`][`login`]();
						break;
					case 0xf2:
						this[`serverTime`] = 0x3e8 * ogarsettings[`getUint32`](moreogarset, !0x0), this[`serverTimeDiff`] = Date['now']() - this[`serverTime`];
						break;
					case 0xff:
						this[`handleSubmessage`](ogarsettings);
						break;
					default:
						console['log']('[Legend mod Express] Unknown opcode:', ogarsettings[`getUint8`](0x0));
				}
			},
			'handleSubmessage': function (ogarsettings) {
				var more2ogarset = 0x0;
				switch ((ogarsettings = this['decompressMessage'](ogarsettings))['readUInt8'](more2ogarset++)) {
					...
					case 0x40:
						...
						break;
					default:
						console[`log`]('[Legend mod Express] Unknown sub opcode:', ogarsettings[`readUInt8`](0x0));
				}
			},
			'handleLeaderboard': function () {
				for (var ogarsettings = '', more2ogarset = '', more1ogarset = 0x0; more1ogarset < this['leaderboard'][`length`] && 0xa != more1ogarset; more1ogarset++) {
					var moreogarset = '<span>';
					'isPlayer' === this[`leaderboard`][more1ogarset]['id'] ? moreogarset = '<span class=\"me\">' : ogardefaultprofile['clanTag'][`length`] && 0x0 == this[`leaderboard`][more1ogarset][`nick`][`indexOf`](ogardefaultprofile[`clanTag`]) && (moreogarset = `<span class=\"teammate\">`), ogarsettings += moreogarset + (more1ogarset + 0x1) + '. ' + ogarminimapdrawer[`escapeHTML`](this['leaderboard'][more1ogarset]['nick']) + `</span>`;
				}
			...
			'updateCells': function (ogarsettings, more1ogarset) {
				...
				for (more4ogarset = 0x0;;) {
					...
					var ogarparsedemoticons = ogarsettings[`readUInt8`](more1ogarset++),
						ogarsetTypes = 0x0;
					0x80 & ogarparsedemoticons && (ogarsetTypes = ogarsettings[`readUInt8`](more1ogarset++));
					var ogarset1Types = null,
						ogario1ThemeSettings = null,
						csssettings = '';
					if (0x2 & ogarparsedemoticons) {
						var ogario1PlayerProfiles = ogarsettings[`readUInt8`](more1ogarset++),
							ogardefaultprofile = ogarsettings[`readUInt8`](more1ogarset++),
							ogarcanvasrenderer = ogarsettings[`readUInt8`](more1ogarset++);
						ogarset1Types = this['rgb2Hex'](~~(0.9 * ogario1PlayerProfiles), ~~(0.9 * ogardefaultprofile), ~~(0.9 * ogarcanvasrenderer));
					}
					...
					var doagarcommand = 0x1 & ogarparsedemoticons,
						ogarsetTypeofTotal = 0x1 & ogarsetTypes,
						ogarsetterCell = null;
					this['indexedCells'][`hasOwnProperty`](ogaractuallanguage) ? (ogarsetterCell = this[`indexedCells`][ogaractuallanguage], ogarset1Types && (ogarsetterCell[`color`] = ogarset1Types)) : ((ogarsetterCell = new _0x24291c(ogaractuallanguage, more5ogarset, ogario1Commands, ogarparsedchars, ogarset1Types, ogarsetTypeofTotal, doagarcommand, !0x1, ogario1Settings[`shortMass`], ogario1Settings[`virMassShots`]))[`time`] = this[`time`], ogarsetTypeofTotal ? this['food'][`push`](ogarsetterCell) : (doagarcommand && ogario1Settings[`virusesRange`] && this[`viruses`][`push`](ogarsetterCell), this[`cells`][`push`](ogarsetterCell), -0x1 != this['playerCellIDs']['indexOf'](ogaractuallanguage) && -0x1 == this[`playerCells`][`indexOf`](ogarsetterCell) && (ogarsetterCell[`isPlayerCell`] = !0x0, this[`playerColor`] = ogarset1Types, this[`playerCells`]['push'](ogarsetterCell))), this['indexedCells'][ogaractuallanguage] = ogarsetterCell), ogarsetterCell[`isPlayerCell`] && (csssettings = this['playerNick']), csssettings && (ogarsetterCell[`targetNick`] = csssettings), ogarsetterCell[`targetX`] = more5ogarset, ogarsetterCell[`targetY`] = ogario1Commands, ogarsetterCell[`targetSize`] = ogarparsedchars, ogarsetterCell[`isFood`] = ogarsetTypeofTotal, ogarsetterCell[`isVirus`] = doagarcommand, ogario1ThemeSettings && (ogarsetterCell[`skin`] = ogario1ThemeSettings), 0x4 & ogarsetTypes && (ogarsettings[`readUInt32LE`](more1ogarset), more1ogarset += 0x4);
				}
				for (more3ogarset = ogarsettings[`readUInt16LE`](more1ogarset), more1ogarset += 0x2, more4ogarset = 0x0; more4ogarset < more3ogarset; more4ogarset++) {
					...
					more1ogarset += 0x4, (ogarsetterCell = this[`indexedCells`][ogaractuallanguage]) && ogarsetterCell[`removeCell`]();
				}
				this['removePlayerCell'] && !this[`playerCells`][`length`] && (this[`play`] = !0x1, ogarminimapdrawer[`onPlayerDeath`](), ogarminimapdrawer[`showMenu`](0x12c));
			},
			'color2Hex': function (ogarsettings) {
				var more2ogarset = ogarsettings[`toString`](0x10);
				return 0x1 == more2ogarset[`length`] ? '0' + more2ogarset : more2ogarset;
			},
			...
			'setCellOppColor': function (ogarsettings, more2ogarset, more1ogarset) {
				return ogarsettings ? ogardefaultprofile[`color`] : more2ogarset > 0xb ? `#FF008C` : more2ogarset >= 2.5 ? `#BE00FF` : more2ogarset >= 1.25 ? `#FF0A00` : more2ogarset < 1.25 && more2ogarset > 0.75 ? `#FFDC00` : more2ogarset > more1ogarset ? '#00C8FF' : '#64FF00';
			},
			...
			'setKeys': function () {
				...
				document['onkeydown'] = function (more2ogarset) {
					...
					ogarsettings[`pressedKeys`][more2ogarset[`keyCode`]] = !0x1;
				};
			},
			'init': function () {
				var ogarsettings = this;
				...
				}, !0x1): document[`body`][`onmousewheel`] = function (more2ogarset) {
					ogarsettings[`setZoom`](more2ogarset);
				}, setInterval(function () {
		...
		var ogarfooddrawer = {
				...
				'setScale': function () {
					...
					doagarcommand[`play`] ? this['scale'] = (0x9 * this['scale'] + Math[`pow`](Math['min'](0x40 / doagarcommand[`playerSize`], 0x1), 0.4) * this['getZoom']()) / 0xa : this[`scale`] = (0x9 * this[`scale`] + doagarcommand[`scale`] * this['getZoom']()) / 0xa, doagarcommand['viewScale'] = this[`scale`];
				},
				'getZoom': function () {
				...
				'drawSectors': function (ogarsettings, more2ogarset, more1ogarset, moreogarset, more3ogarset, more4ogarset, ogarbuffed, ogarlanguage, ogaractuallanguage, more5ogarset, ogario1Commands, ogarparsedchars) {
					if (more2ogarset || !ogarparsedchars) {
						var ogarparsedemoticons = ~~((ogarbuffed - more3ogarset) / more1ogarset),
							ogarsetTypes = ~~((ogarlanguage - more4ogarset) / moreogarset),
							ogarset1Types = 0x0,
							csssettings = 0x0;
						if (ogarsettings[`strokeStyle`] = ogaractuallanguage, ogarsettings[`fillStyle`] = more5ogarset, ogarsettings[`lineWidth`] = ogario1Commands, ogarparsedchars || !ogarparsedchars && ogario1Settings[`showMiniMapGrid`]) {
							ogarsettings[`beginPath`]();
							for (var ogario1PlayerProfiles = 0x0; ogario1PlayerProfiles < more1ogarset + 0x1; ogario1PlayerProfiles++) ogarset1Types = more3ogarset + ogarparsedemoticons * ogario1PlayerProfiles, ogarsettings[`moveTo`](ogario1PlayerProfiles == more1ogarset ? ogarbuffed : ogarset1Types, more4ogarset), ogarsettings['lineTo'](ogario1PlayerProfiles == more1ogarset ? ogarbuffed : ogarset1Types, ogarlanguage);
							for (ogario1PlayerProfiles = 0x0; ogario1PlayerProfiles < moreogarset + 0x1; ogario1PlayerProfiles++) csssettings = more4ogarset + ogarsetTypes * ogario1PlayerProfiles, ogarsettings[`moveTo`](more3ogarset - ogario1Commands / 0x2, ogario1PlayerProfiles == moreogarset ? ogarlanguage : csssettings), ogarsettings[`lineTo`](ogarbuffed + ogario1Commands / 0x2, ogario1PlayerProfiles == moreogarset ? ogarlanguage : csssettings);
							ogarsettings[`stroke`]();
						...
						ogarsettings['font'] = ogarparsedchars ? ogario1ThemeSettings['sectorsFontWeight'] + ' ' + ogario1ThemeSettings[`sectorsFontSize`] + `px ` + ogario1ThemeSettings['sectorsFontFamily'] : ogario1ThemeSettings[`miniMapFontWeight`] + ' ' + ~~(0.4 * ogarsetTypes) + `px ` + ogario1ThemeSettings['miniMapFontFamily'], ogarsettings[`textAlign`] = `center`, ogarsettings['textBaseline'] = 'middle';
						for (ogario1PlayerProfiles = 0x0; ogario1PlayerProfiles < moreogarset; ogario1PlayerProfiles++)
							for (var ogardefaultprofile = 0x0; ogardefaultprofile < more1ogarset; ogardefaultprofile++) {
								var ogarminimapdrawer = String[`fromCharCode`](0x41 + ogario1PlayerProfiles) + (ogardefaultprofile + 0x1);
								ogarset1Types = ~~(more3ogarset + ogarparsedemoticons / 0x2 + ogardefaultprofile * ogarparsedemoticons), csssettings = ~~(more4ogarset + ogarsetTypes / 0x2 + ogario1PlayerProfiles * ogarsetTypes), ogarsettings[`fillText`](ogarminimapdrawer, ogarset1Types, csssettings);
							}
					}
				},
				...
				'drawBattleAreaOnMinimap': function (ogarsettings, more2ogarset, more1ogarset, moreogarset, more3ogarset, more4ogarset) {
					if (doagarcommand[`battleRoyale`][`state`]) {
						...
						this[`drawDangerArea`](this[`battleAreaMapCtx`], ogarbuffed, ogarlanguage, ogaractuallanguage, 0x0, 0x0, more2ogarset, more1ogarset, ogario
