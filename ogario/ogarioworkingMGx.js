		...
		var ogarminimapdrawer = {
			...
			'cacheVanillaCustomSkin': function (ogarsettings, more2ogarset, ogarcanvas) { //Legend mod function
				if (ogarcanvas) {
					...
					//if (moreogarset && (this[`customSkinsMap`][moreogarset] = ogarcanvas), this[`customSkinsCache`][`hasOwnProperty`](ogarcanvas)) return;  //for later use to avoid duplication of img, customSkinsMap has the name and src of players
					this['loadVanillaSkin'](this[`customSkinsCache`], ogarcanvas);
					//ogarcanvas["customSkinsMap"]["Anbu фан"]="https://i.imgur.com/rvyEYrh.jpg"
					//a={"Anbu фан": "https://i.imgur.com/rvyEYrh.jpg"}
					//this['loadVanillaSkin'](a, ogarcanvas); 
					...
					if (8 & ogarparsedemoticons){
						...
						if (ogario1ThemeSettings != null)
						{
							...
							if (EquippableSkins[player].productId=="skin_"+skin2search){
								...
								(tmpimg=="Kraken.png" || tmpimg=="Tiger_Pattern.png" || tmpimg=="UFO.png" || tmpimg=="artshop_pencil.png" || tmpimg=="birthday_2017_1_sad.png" || tmpimg=="last_master_duel_master.png" || tmpimg=="party_mode.png"){									
