			...
			'updateCells': function (ogarsettings, more1ogarset) {
				...
				for (more4ogarset = 0;;) {
					...
					if (8 & ogarparsedemoticons){
						...
						for (var player = 0; player < GameConfiguration.gameConfig["Gameplay - Equippable Skins"].length; player++) {
						//console.log(GameConfiguration.gameConfig["Gameplay - Equippable Skins"]);
							if (GameConfiguration.gameConfig["Gameplay - Equippable Skins"][player].productId=="skin_"+skin2search){
								console.log(GameConfiguration.gameConfig["Gameplay - Equippable Skins"][player].cellColor);
								console.log(GameConfiguration.gameConfig["Gameplay - Equippable Skins"][player].skinType);
								console.log(GameConfiguration.gameConfig["Gameplay - Equippable Skins"][player].gameplayId);
								console.log(GameConfiguration.gameConfig["Gameplay - Equippable Skins"][player].image);
						}
					}							
