...
class Spect {
	...
	constantrecalculation3(x,y){	
		this.fix3x = this.convertX(legendmod.playerCells[0].x) - x
		this.fix3y = this.convertY(legendmod.playerCells[0].y) - y
		console.log('found user cell',this.convertX(legendmod.playerCells[0].x),this.convertY(legendmod.playerCells[0].y),legendmod.playerCells[0].x,legendmod.playerCells[0].y,cell.x,cell.y)
	}
	beforecalculation(){
