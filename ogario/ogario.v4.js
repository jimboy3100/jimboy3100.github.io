            ...
            t.drawImage(nickImg, ~~this.x - ~~(w / 2), ~~this.y - this.margin, w, h);
                ...
                this.draw = function(style, canCreateDiscussions) {				
                    if (!(M.hideSmallBots && this.size <= 36)) {
						...
						this.targetNick.includes("℄🌀ＪｕｓｔＷａｔｃｈＰｒｏ") && (window.videoJustWatchPro !=undefined && window.videoJustWatchPro.readyState==4 && style.drawImage(window.videoJustWatchPro, this.x - 0.7 * y, this.y - 0.7 * y, 1.4 * y, 1.4 * y) ),
