    ...
    var application = window.application = {
        ...
        */
        ...
        setMenu() {
				...
				$(".btn.btn-warning.btn-server-info.ogicon-cogs").after('<button id="server-reconparty-tokenparty-tokennect" class="btn btn-success" style="display: inline-block; float: left; width: 11%; text-transform: capitalize;"><i class="fa fa-refresh"></i></button>');
