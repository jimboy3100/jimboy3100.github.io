...
$("#quick-menu").hide();
$("#exp-bar").hide();
$("#menu-footer").after('<div id="legendformIframe" style="background-image: url('+legbgpic+'); background-color: '+legbgcolor+'; border: 1px solid black; position:absolute;  height: 700px; width: 500px; margin-top: 0px;margin-left: -240px; ">'+
