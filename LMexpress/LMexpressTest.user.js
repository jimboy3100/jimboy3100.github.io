// ==UserScript==
// @name         Legend Express Agar.io Extension - TEST
// @namespace    Legend Express Agario Mod - TEST
// @version      1.8
...
// @downloadURL  https://jimboy3100.github.io/LMexpress/LMexpressTest.user.js
// @updateURL    https://jimboy3100.github.io/LMexpress/LMexpressTest.user.js
...
switch (mode) {
    ...
    case 'delta':
        ...
        break;
    case 'neo':
        modwebsite = 'https://www.legendmod.ml/play.test.html?' + version;
        Htmlscript(modwebsite);
        setTimeout(function () {
        ...
        break;
    case 'mobile':
        modwebsite = 'https://www.legendmod.ml/play.test.html';
        Htmlscript(modwebsite);
        setTimeout(function () {
