...
var Languageletter64="Αυτόματη απόκρυψη φαγητού";		//Auto hide food (zoom) 
...
var Premadeletter86 = "στην προσαρμοσμένη περιοχή Url δέρματος"; //to custom skin Url area
...
var Premadeletter96 = "στην προσαρμοσμένη περιοχή Url του δέρματος για να ενεργοποιήσετε τη λειτουργία ψεύτικης σημαίας"; // o custom skin Url area in order to activate the fake flag function
...
var Premadeletter104 = "Διαγράψτε τη διεύθυνση URL του προσαρμοσμένου δέρματος"; //Erase custom skin URL
...
var Premadeletter109 = "Ανέβασμα / κατέβασμα"; //Upload / Download
